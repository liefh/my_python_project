...
#         gauge_validator_effectiveness = Gauge('validator_effectiveness','Obol custom monitor about business',registry=REGISTRY)
#         gauge_validator_status = Gauge('validator_status','Obol custom monitor about business',registry=REGISTRY)
#
...
#
#         # print(gauge_validator_effectiveness)
#         # print(gauge_validator_status)
#         time.sleep(10)
