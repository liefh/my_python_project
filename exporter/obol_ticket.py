...
def get_label(prefix_url,ovalidator_index):
    ...
    try:
        while True:
            ...
            tmp = bs.select('body > main > div > div:nth-child(2) > div.col-lg-8.px-lg-2.my-2 > div > div.d-flex.flex-column.justify-content-center > div.overview-container.d-flex.flex-wrap.justify-content-center > div:nth-child(4) > span.text-success')
            validator_effectiveness = int(tmp[0].get_text().split('-')[0].strip().strip('%'))
            tmp = bs.select('body > main > div > div:nth-child(2) > div.col-lg-8.px-lg-2.my-2 > div > div.d-flex.flex-column.justify-content-center > div.overview-container.d-flex.flex-wrap.justify-content-center > div:nth-child(3) > b')
            validator_status = 0
